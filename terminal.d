...
version(Windows) {
    ...
    //import mach.text.cstring.convert : toStringz = tocstring;
    private {
        enum RED_BIT = 4;
        enum GREEN_BIT = 2;
        enum BLUE_BIT = 1;
...
struct Terminal {
    ...
    */
    ...
    string getline(string prompt = null) {
        ...
        auto input = RealTimeConsoleInput(&this, ConsoleInputFlags.raw); // | ConsoleInputFlags.allInputEvents);
